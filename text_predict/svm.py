...
class TextPredict(object):
    def __init__(self):
        ...
        self.db_train = file.get_dbtrain()
        self.db_answers = file.get_dbanswers()
        self.db_train_extend = file.get_dbtrain_extend()


    def Text_Predict(self, human_message):
        self.question_test = human_message
    ...
    def GridSearchCV(self):
        ...
        if (self.model.__class__.__name__ == "SVM_Model"):
...
#     predict = TextPredict(txt, file.get_dbtrain(), file.get_dbtrain_extend(), file.get_dbanswers())
